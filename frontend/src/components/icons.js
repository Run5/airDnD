...
export const twSquare = <FontAwesomeIcon icon={ faTwitterSquare } />
export const userIcon = <FontAwesomeIcon icon={ faUserCircle } />
export const keyIcon = <FontAwesomeIcon icon={ faKey } />
export const d20 = <FontAwesomeIcon icon={ faDiceD20 } />
